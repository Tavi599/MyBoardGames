...
const STATUS = {"хочу":"хочу зіграти","колекція":"у колекції","улюблена":"улюблена",
                "онлайн":"онлайн","відклав":"відклав","позбувся":"позбувся"};
/* Коробка або стоїть на полиці, або її вже нема: «у колекції» й «позбувся»
   разом не бувають, тож увімкнення одного гасить інший. Решта статусів
   поєднується вільно — позбувся коробки, а грати онлайн не перестав. */
const НЕСУМІСНІ = [["колекція", "позбувся"]];
...
/** Гасить статус, несумісний із щойно ввімкненим. Повертає той самий набір. */
