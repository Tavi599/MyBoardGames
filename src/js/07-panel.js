...
function сховатиПорожні(){
  ...
  // Указник живе в окремому рядку — ховаємо разом із ним, інакше
  // лишиться порожня смуга з відступом.
  const указник = $("abc").querySelector(".seg");
  $("abc").hidden = !указник || указник.hidden;
}
